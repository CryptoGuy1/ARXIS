"""DEPRECATED. Superseded by retrain/make_figs_v2.py and make_figs_arch.py.

This script draws two figures from the v1 result files under retrain/results/.
No figure in the manuscript or the supporting information comes from it. It is
