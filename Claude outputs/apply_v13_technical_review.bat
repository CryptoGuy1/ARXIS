@echo off
REM ============================================================================
REM  ARXIS - apply the 14 September technical review round to the repository,
...
REM      commit_v13_technical_review_message.txt
REM
...
set BRANCH=arxis-v13-technical-review
set TAG=v13-submission
set DROP=arxis_v13_repo_drop.zip
set MSG=commit_v13_technical_review_message.txt
